...
/**
 *  source .env && forge script script/ArchitectureDeployments/anvil/DeployDeployer.s.sol:DeployDeployerScript --with-gas-price 30000000000 --slow --broadcast --etherscan-api-key $ETHERSCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployDeployerScript is Script, ContractNames, AnvilAddresses {
    ...
    function run() external {
        ...
        rolesAuthority =
            RolesAuthority(deployer.deployContract(AnvilVaultRolesAuthorityName, creationCode, constructorArgs, 0));
