...
/**
 *  source .env && forge script script/ArchitectureDeployments/Avalanche/rggAVAX/DeployRggavaxDeployer.s.sol:DeployRggavaxDeployer --slow --broadcast --verifier-url 'https://api.routescan.io/v2/network/mainnet/evm/43114/etherscan' --etherscan-api-key "verifyContract" --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployRggavaxDeployer is Script, ContractNames, AvalancheAddresses {
