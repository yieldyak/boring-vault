...
/**
 *  source .env && forge script script/ArchitectureDeployments/Avalanche/yyAVAXai/DeployAVAXMilkAIDeployer.s.sol:DeployAVAXMilkAIDeployer --slow --broadcast --verifier-url 'https://api.routescan.io/v2/network/mainnet/evm/43114/etherscan' --etherscan-api-key "verifyContract" --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployAVAXMilkAIDeployer is Script, ContractNames, AvalancheAddresses {
