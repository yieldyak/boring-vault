...
/**
 * source .env && forge script script/ArchitectureDeployments/Base/yiUSD/DeployIntelligentUSDDeployerBase.s.sol:DeployIntelligentUSDDeployerBase --account yak-deployer
 * forge script script/ArchitectureDeployments/Base/yiUSD/DeployIntelligentUSDDeployerBase.s.sol:DeployIntelligentUSDDeployerBase --account deployer --slow --broadcast --verify --verifier etherscan
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployIntelligentUSDDeployerBase is Script, ContractNames, BaseAddresses {
    // Contracts to deploy
