...
/**
 *  source .env && forge script script/ArchitectureDeployments/sepolia/DeployDeployer.s.sol:DeployDeployerScript --with-gas-price 30000000000 --slow --broadcast --etherscan-api-key $ETHERSCAN_KEY --verify
...
contract DeployDeployerScript is Script, ContractNames, SepoliaAddresses {
    ...
    function run() external {
        ...
        rolesAuthority =
            RolesAuthority(deployer.deployContract(SepoliaVaultRolesAuthorityName, creationCode, constructorArgs, 0));
