...
/**
 *  source .env && forge script script/MerkleRootCreation/Avalanche/rsAVAX/CreateAvalancheSuzakuDCStrategistMerkleRoot.s.sol:CreateAvalancheSuzakuDCStrategistMerkleRoot --rpc-url $AVALANCHE_RPC_URL
 */
contract CreateAvalancheSuzakuDCStrategistMerkleRoot is Script, MerkleTreeHelper {
    ...
    function run() external {
        ...
        string memory filePath = "./leafs/avalanche_rsAVAX_suzaku_dc_strategist.json";
